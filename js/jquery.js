...
function addMap(){/*
  ...
  var select_native_1 = $('#select-native-1').val();
  var porcion = select_native_1.substring(10); 
  //alert(porcion);
  var meteograma = $('#select-native-2').val();
  var parametrizaciones = $('#select-native-3').val();
  var variables = $('#select-native-4').val();
  ...
  //alert("http://10.209.2.98/media/demonio/imagenes/"+año+""+mes+""+dia+"/zona"+meteograma+"/"+parametrizaciones+"/"+variables+"/"+hora+".png");
  $("#image").attr("src", "http://10.209.2.98/media/demonio/imagenes/"+año+""+mes+""+dia+"/zona"+meteograma+"/"+parametrizaciones+"/"+variables+"/"+hora+".png");
  ...
  $("#point").change(function(){
    ...
    $("#hora").text("Fecha: " + dia + "/" + mes + "/" + año + " Hora: " + valor + ":00");
      $("#image").attr("src", "http://10.209.2.98/media/demonio/imagenes/"+año+""+mes+""+dia+"/zona"+meteograma+"/"+parametrizaciones+"/"+variables+"/"+valor+".png");
      //$("#image").attr("src", "http://www.aemet.es/imagenes_d/eltiempo/observacion/satelite/" + año + "" + mes + "" + day + "" + valor + "00_s93g.gif");
  });*/
}
function addZero(i) {
